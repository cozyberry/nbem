#! /usr/bin/python
"""
Documentation of one example how we use MultinomialNBEM class to train naive bayesian network with unlabeled data.

If true label information is available, it shows how to test it with labeled test data as well
